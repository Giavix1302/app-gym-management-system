// UserMessagesScreen - List of conversations for User role
// Shows conversations with trainers (PT)
...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'UserMessages'>;
