// PTMessagesScreen - List of conversations for PT (Trainer) role
// Shows conversations with students (Users)
...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'PTMessages'>;

export default function PTMessagesScreen() {
    ...
    async (pageNum: number = 1, isRefresh: boolean = false) => {
      ...
      try {
        ...
        const response = await messagingService.getConversations(
          ...
          pageNum,
          20,
          'pt' // PT role - changed from 'trainer' to 'pt'
        );
      ...
      <View className="border-b border-gray-200 bg-white px-4 py-3">
        <View className="flex-row items-center justify-between">
          <View className="flex-row items-center gap-3">
            ...
            <Text className="text-2xl font-bold text-gray-900">Học viên</Text>
          </View>
        </View>
      </View>
